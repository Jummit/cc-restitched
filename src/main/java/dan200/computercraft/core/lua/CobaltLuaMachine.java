...
public class CobaltLuaMachine implements ILuaMachine {
    ...
    public CobaltLuaMachine(Computer computer, TimeoutState timeout) {
        ...
        if (ComputerCraft.getConfig().debug_enable) {
        ...
        this.m_globals.rawset("_HOST",
                              valueOf(computer.getAPIEnvironment()
                                         ...
                                         .getHostString()));
        this.m_globals.rawset("_CC_DEFAULT_SETTINGS", valueOf(ComputerCraft.getConfig().default_computer_settings));
        if (ComputerCraft.getConfig().disable_lua51_features) {
